...
if __name__ == '__main__':
    ...
    default_task_description_file_path = 'prompts/task_description_5.txt'
    parser.add_argument(
    ...
    default_user_nlg = 'rulebased'
    user_nlg_values = [default_user_nlg, 'sclstm']
    parser.add_argument(
    ...
    if args.user_simulator == 'ours':
        ...
        user_agent = (
            UserSimulatorE2E(
                ...
                shots_file='data/multiwoz/train_modified.json',
